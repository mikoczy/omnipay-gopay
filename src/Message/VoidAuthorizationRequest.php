 ...
 */
class VoidAuthorizationRequest extends AbstractRequest
{
    ...
    public function sendData($data)
    {
        ...
        $httpResponse = $this->httpClient->request(
            'POST',
            $this->getParameter('apiUrl') . '/api/payments/payment/' . $transactionReference . '/void-authorization',
            $headers,
            json_encode($data)
        );
        ...
        $response = new VoidAuthorizationResponse($this, $cancelResponseData);
        return $response;
    }
